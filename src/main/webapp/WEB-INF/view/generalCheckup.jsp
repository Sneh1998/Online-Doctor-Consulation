...
<body>
	...
	<section>
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active">General CheckUp</li>
		</ol>
	</section>
	...
	<section>
		<div>
			<h3 class="mb-2 text-center" style="font-size: 45px;">Our
				Doctors and Specialists</h3>
		</div>
			...
			<div class="feature-grids row text-center">
				<div class="col-lg-4 gd-bottom one">
					<a href="#appointment" target="_self">
						<div class="bottom-gd inner-div">
							...
							<label class="mb-2 labelClass">Dr Sharad Panwar</label>

							<p>General Physician 8-years experience</p>
				...
				<div class="col-lg-4 gd-bottom one">
					<a href="#appointment" target="_self">
						<div class="bottom-gd inner-div">
							<div class="doctors">
								<span class="fas fa-user-nurse doctors" aria-hidden="true"></span>
							</div>
							<label class="mb-2 labelClass">Dr Anita Joshi</label>
							<p>General Physician 5-years experience</p>
							<button class="btn btn-primary mb-2">Book Appointment</button>
						</div>
					</a>
				</div>
				<div class="col-lg-4 gd-bottom one">
					<a href="#appointment" target="_self">
						<div class="bottom-gd inner-div">
							...
							<label class="mb-2 labelClass">Dr Yatin Kukreja</label>
							<p>MBBS, Physician</p>
							<button class="btn btn-primary mb-2">Book Appointment</button>
						</div>
					</a>
				...
				<div class="col-lg-4 gd-bottom one">
					<a href="#appointment" target="_self">
						<div class="bottom-gd inner-div">
							...
							<label class="mb-2 labelClass">Dr Virendr Kumar</label>
							<p>Physician, MBBS</p>
							<button class="btn btn-primary mb-2">Book Appointment</button>
						</div>
					</a>
				...
				<div class="col-lg-4 gd-bottom one">
					<a href="#appointment" target="_self">
						<div class="bottom-gd inner-div">
							...
							<label class="mb-2 labelClass">Dr Amitabh Khanna</label>
							<p>Senior Physician 10-years experience</p>
							<button class="btn btn-primary mb-2">Book Appointment</button>
						</div>
					</a>
				</div>
				<div class="col-lg-4 gd-bottom one">
					<a href="#appointment" target="_self">
						<div class="bottom-gd inner-div">
							...
							<label class="mb-2 labelClass">Dr Seema Thakur</label>
							<p>General Physician 4-years experience</p>
							<button class="btn btn-primary mb-2">Book Appointment</button>
						</div>
					</a>
				</div>
							...
							<div class="chat-container">
								<div class="modal-header">
									<div class="chat-header">
										<h4 class="modal-title">JavaTechie Global Chat Box</h2>
							...
							<div class="col-lg-5 col-2">
								...
								<div class="row no-gutter">
									...
									<div>
										...
										<input type="hidden" name="moduleName" value="generalSection">
										...
										<select id="discuss" class="appointDiscuss fieldValidate"  name="discussChoice"  error-id="discussChoiceError" />
											...
											<option value="headache">About Headache</option>
											<option value="fever">About Fever</option>
											<option value="cold-cough">About Cold and Cough</option>
											<option value="stomach-ache">About Stomach-ache</option>
											<option value="general">About general fitness</option>
											<option value="vomiting">About Vomiting</option>
										</select>
									...
									<div class="col-md-12">
										<button type="submit" class="btn btn-warning" name="submit" id="btn1">Click to Book Appointment</button>
									</div>
								</div>
							</div>
	...
	<section style="background-color: #bbb">
		<div class="container">
