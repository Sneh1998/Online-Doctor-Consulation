				...
				<div class="col-lg-4 gd-bottom one">
					<a href="#bookingModule">
						<div class="bottom-gd inner-div">
							...
							<label class="mb-2 labelClass">Dr Sushma Chawla</label>
				...
				<div class="col-lg-4 gd-bottom one">
					<a href="#bookingModule">
						<div class="bottom-gd inner-div">
							...
							<label class="mb-2 labelClass">Dr Kashish Miglani</label>
							<p>Cardiac-Consultant 5-years experience</p>
							<button class="btn btn-primary mb-2">Book Appointment</button>
						</div>
					</a>
				</div>
				<div class="col-lg-4 gd-bottom one">
					<a href="#bookingModule">
						<div class="bottom-gd inner-div">
							...
							<label class="mb-2 labelClass">Dr Ramesh Kumar</label>
							<p>Cardiac-Surgeon 10 years experience</p>
							<button class="btn btn-primary mb-2">Book Appointment</button>
						</div>
					</a>
				</div>
				<div class="col-lg-4 gd-bottom one">
					<a href="#bookingModule">
						<div class="bottom-gd inner-div">
							...
							<label class="mb-2 labelClass">Dr Ashok Seth</label>
							<p>Neurologist, MBBS 10 years</p>
							<button class="btn btn-primary mb-2">Book Appointment</button>
						</div>
					</a>
				</div>
				<div class="col-lg-4 gd-bottom one">
					<a href="#bookingModule">
						<div class="bottom-gd inner-div">
							...
							<label class="mb-2 labelClass">Dr Seema Miglani</label>
							<p>Cardiologist 9-years experience</p>
							<button class="btn btn-primary mb-2">Book Appointment</button>
						</div>
					</a>
				</div>
				<div class="col-lg-4 gd-bottom one">
					<a href="#bookingModule">
						<div class="bottom-gd inner-div">
							...
							<label class="mb-2 labelClass">Dr Ajay Kaul</label>
							<p>Cardiac-Surgeon 15-years experience</p>
							<button class="btn btn-primary mb-2">Book Appointment</button>
						</div>
					</a>
				</div>
					...
					<div class="container" id="registerBox" >
						<div class="row">
							<div class="col-lg-5 col-2">
								...
								<div class="row no-gutter">
									<div>
									<input type="hidden" name="moduleName" value="Cardiac Section">
										...
										<select id="discuss" class="appointDiscuss fieldValidate"  name="discussChoice"  error-id="discussChoiceError" />
											...
											<option value="high BP">About High Blood pressure</option>
											<option value="low BP">About Low Blood Pressure	</option>
											<option value="Abnormal heartbeats">About Abnormal Heartbeats</option>
										</select>
