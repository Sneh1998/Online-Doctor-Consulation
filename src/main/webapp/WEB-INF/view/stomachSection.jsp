...
.col-1{
	background-image:url("/img/stomach.jpg");
...
body {
	background-image: url("/img/doc16.jpg");
}
</style>
</head>
<body>
	...
	<section>
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active">Brain CheckUp</li>
		</ol>
	</section>
	...
	<section>
		<div>
			<h3 class="mb-2 text-center"
				style="font-size: 45px; background-color: black; color: white">Cardiologists & cardiac-Specialists</h3>
		</div>
				...
				<div class="col-lg-4 gd-bottom one">
					<a href="#bookingModule">
						<div class="bottom-gd inner-div">
							...
							<label class="mb-2 labelClass">Dr Sunil Sobti</label>

							<p>Gastro-Specialist 6-years experience</p>
				...
				<div class="col-lg-4 gd-bottom one">
					<a href="#bookingModule">
						<div class="bottom-gd inner-div">
							...
							<label class="mb-2 labelClass">Dr Anoop Mishra</label>
							<p>Liver-Specialist 5-years experience</p>
							<button class="btn btn-primary mb-2">Book Appointment</button>
						</div>
					</a>
				</div>
				<div class="col-lg-4 gd-bottom one">
					<a href="#bookingModule">
						<div class="bottom-gd inner-div">
							...
							<label class="mb-2 labelClass">Dr Mahesh Paliwal</label>
							<p>Gastroenterologist 10-years experience</p>
							<button class="btn btn-primary mb-2">Book Appointment</button>
						</div>
					</a>
				</div>
				<div class="col-lg-4 gd-bottom one">
					<a href="#bookingModule">
						<div class="bottom-gd inner-div">
							...
							<label class="mb-2 labelClass">Dr Rekha Bansal</label>
							<p>Gastro-Specialist 9-years experience</p>
							<button class="btn btn-primary mb-2">Book Appointment</button>
						</div>
					</a>
				</div>
				<div class="col-lg-4 gd-bottom one">
					<a href="#bookingModule">
						<div class="bottom-gd inner-div">
							...
							<label class="mb-2 labelClass">Dr Sanjeev Kumar</label>
							<p>Gastroenterologist 9-years experience</p>
							<button class="btn btn-primary mb-2">Book Appointment</button>
						</div>
					</a>
				</div>
				<div class="col-lg-4 gd-bottom one">
					<a href="#bookingModule">
						<div class="bottom-gd inner-div">
							...
							<label class="mb-2 labelClass">Dr Aarogya Khanna</label>
							<p>Gastro-Specialist 7-years experience</p>
							<button class="btn btn-primary mb-2">Book Appointment</button>
						</div>
					</a>
				</div>
					...
					<div class="container" id="registerBox" >
						<div class="row">
							<div class="col-lg-5 col-2">
								...
								<div class="row no-gutter">
									<div>
									<input type="hidden" name="moduleName" value="Stomach Section">
										...
										<select id="discuss" class="appointDiscuss fieldValidate"  name="discussChoice"  error-id="discussChoiceError" />
											...
											<option value="stomach flu">About Stomach Flu</option>
											<option value="stomach flu">About Stomach Health</option>
											<option value="liver sensitivity">About Liver Sensitivity</option>
											<option value="constipation">About Constipation</option>
										</select>
